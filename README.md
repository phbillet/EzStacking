...
_Notes:_
* _time-dependent problems benefit from specific interactive visualization tools based on [statmodels](https://www.statsmodels.org/stable/index.html):_
  - _seasonal decomposition with one period_
  - _seasonal decomposition with two periods_
  - _unobserved components decomposition_
